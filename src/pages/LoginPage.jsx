      ...
      <div className="relative w-full max-w-lg glass-panel rounded-3xl p-8 sm:p-10 border border-brand-red/40 shadow-[0_0_60px_rgba(255,0,51,0.2)]">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-black text-white">
            {mode === 'login' ? 'সিকিউর পোর্টাল লগইন' : 'পাসওয়ার্ড রিসেট করুন'}
          </h2>
        ...
        {mode === 'login' && (
          <>
            ...
            {/* TAB 1: ADMIN LOGIN (STRICT EMAIL & PASSWORD) */}
            {loginRoleTab === 'admin' && (
              <div className="space-y-4 animate-fade-in">
                ...
                >
                  ...
                  <span>Google SSO দিয়ে সাইন ইন করুন</span>
                </button>

                <div className="relative my-4 text-center">
                  <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-slate-800" /></div>
                  <span className="relative px-3 bg-dark-900 text-[11px] text-slate-500 font-medium">অথবা ইমেইল ও গোপন পাসওয়ার্ড লিখুন</span>
                </div>

                <form onSubmit={handleAdminLoginSubmit} className="space-y-4">
                  <div>
                    <label className="block text-xs font-medium text-slate-300 mb-1.5">অ্যাডমিন ইমেইল (Admin Email)</label>

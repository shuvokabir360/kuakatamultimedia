...
export default function FinanceHome({ onNavigate }) {
  ...
  return (
    <div className="space-y-6 pb-8 animate-fade-in">
      ...
      {/* 3 Overview Cards Container (Grid on PC Desktop, Stacked on Mobile) */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">

        {/* 1. MAIN CARD: মোট বকেয়া (Dynamic & Live Saved) */}
        <div className="bg-gradient-to-br from-red-500 via-rose-600 to-red-600 text-white rounded-3xl p-5 shadow-xl shadow-red-500/20 space-y-4 relative overflow-hidden flex flex-col justify-between">
          ...
          {/* Action Row */}
          <div className="pt-3 flex items-center justify-between gap-3 border-t border-white/15">
            <div>
        ...
        <div className="bg-white rounded-3xl p-5 border border-slate-200/80 shadow-md space-y-4 flex flex-col justify-between">
